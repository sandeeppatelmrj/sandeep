...
function cleanMojibake(obj) {
    ...
    if (obj !== null && typeof obj === 'object') {
        ...
        for (const key in obj) {
            cleaned[key] = cleanMojibake(obj[key]);
        }
        return cleaned;
    }
    return obj;
...
function getSiteData() {
    ...
    // SAFE FORCE-OVERRIDE for users with old cached local storage
    try {
...
function updateDOMFromCMS() {
    ...
    if (data.home_hero_particles_visibility === 'hide') {
        ...
        const particleCanvas1 = document.getElementById('interactive-bg');
        if (particleCanvas1) particleCanvas1.style.display = 'block';
        const particleCanvas2 = document.getElementById('hero-interactive-canvas');
...
/* Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ Dynamic Lenis Loader Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ */
/* Lenis loader removed (Lenis is loaded statically via script tags in HTML) */

/* Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ Init on DOM Ready Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ */
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        if (raw) {
            ...
            if (data.home_about_profile_badge === 'CREATIVE DIRECTOR · DELHI' || (data.home_about_bio_p1 && data.home_about_bio_p1.indexOf('15+ years of experience') !== -1)) {
    ...
    try {
        ...
        if (rawSettings) {
            ...
            if (!settings.nav_links || !settings.nav_links.includes('Photography')) {
                settings.nav_links = settings.nav_links ? settings.nav_links + ', Photography|Photography.html' : 'Work|work.html, Museum Experience|museum.html, What I Do|what-i-do.html, About|about.html, Contact|contact.html, My Story|sandeep-story.html, Photography|Photography.html';
                updatedSettings = true;
            }
            if (updatedSettings) {
...
/* Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ Expose helpers globally Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ */
window.getSiteData    = getSiteData;
window.updateDOMFromCMS = updateDOMFromCMS;

/* Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ Accessible Mobile Hamburger Menu & Drawer Overlay Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ */
...
/* Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ Dynamic Pagination & Related Projects for Case Studies Ãƒ¢Ã¢â‚¬Ã¢â€š¬Ãƒ¢Ã¢â‚¬Ã¢â€š¬ */
